...
MOGAO SAM MALO POPRAVITI FUNKCIJU KAKO BI SE MOZDA MOGLI PASS-OVATI IN I SORT I ORDER
...
I TU JE SVE U REDU, NE MORAM RUN-OVATI FILE DA BILO STA PROVERIM, JER CIM JE RADILO RANIJE KAKO TREBA RADICE I SADA, A U TO CES SE UVERITI AKO TI ZELIS DA RUN-UJES FILE

# ERROR HANDLING

TACNIJE JA CU SAMO DA HANDLE-UJEM STATUS CODES

I AKO TO NIJE 200 JA CU DA RAISE-UJEM ERROR

A TO CU RADITI SA `raise` KEYWORD-OM, SA KOJIM CU SE POZABAVITI NEKOM DRUGOM PRILIKOM IN DETAIL
...
SADA CU RUNN-OVATI FILE

TREBALO BI SADA DA BUDE RAISED ERROR, ODNOSNO D UPRAVO TO VIDIM U TERMINALU
...
AKO HOCES DA TI SVE OPET FUNKCIONISE, SAMO ZAMENI ONAJ INVALIDNI GITHUB URL SA VALIDNIM