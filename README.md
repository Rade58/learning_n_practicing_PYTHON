...
**ONO STA JOS FUNKCIONISE JESTE** <kbd>Ctrl</kbd> + <kbd>D</kbd>
...
`"/home/eidolonro/PROJECTS/GITHUB IMPORTANT /learning_and_practicing_phyton/env/bin/python"`

JASNO TI JE KADA SAM GOVORIO RANIJE DA MORAS ACTIVATE-OVATI

ONO OTVARANJE REPLA TO RADI AUTOMATSKIM, USTVARI AUTOMATSKI PROSLEDJUJE DA BI SE ACTIVATE-OVAO REPL

A IMAM OVJ LINK DA TO URADIM MANUELNO PONOVO, JER MI VS CODE DAJE KORISNU STVAR ODNONO DAJE MI JE U TERMINAL DA REOPEN-UJEM VEOM BRZO

A MOGAO SAM OPET DA PRITISNEM <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd> PA `python: start REPL`
